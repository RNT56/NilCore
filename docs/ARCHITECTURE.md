...
| `internal/report` | read-only verification-report model over the append-only log | `eventlog`, `artifact`, `worktreefs` |
| `internal/report/render` | text / HTML / markdown renderers for the verification report | `internal/report`, `termui` |
